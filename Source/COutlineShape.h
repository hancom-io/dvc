...
namespace CheckListModule {
    class COutlineShape : public IOutlineShape
    {
    public:
        COutlineShape(std::string dvcFile);
        COutlineShape(LPCSTR document);
        ~COutlineShape();

    public:
        DVCType getType() { return DVCType::OutlineShape; }
